...
#region Constructors
        internal MotionData()
        {
            ...
            m_IsFirstFrame = true;
            m_LastFrameActive = -1;
            m_ViewProjectionMatrix = new Matrix4x4[] { Matrix4x4.identity, Matrix4x4.identity };
            m_PreviousViewProjectionMatrix = new Matrix4x4[] { Matrix4x4.identity, Matrix4x4.identity };
        }
#endregion
